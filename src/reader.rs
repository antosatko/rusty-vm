    ...
    impl Reader {
        ...
        fn push_consts(&mut self) {
            ...
            let value = match self.file.as_bytes()[self.pos - 1] {
                ...
                73 => Types::Function(self.read_unumber(32) as usize),
                _ => {
                    panic!(
        ...
        fn push_instruction(&mut self) {
            ...
            let instruction = match self.file.as_bytes()[self.pos - 1] {
                65 => Instructions::Wr(self.read_unumber(2), self.read_unumber(1)),
                66 => Instructions::Rd(self.read_unumber(2), self.read_unumber(1)),
                67 => Instructions::Wrp(self.read_unumber(1)),
                68 => Instructions::Rdp(self.read_unumber(1)),
                69 => Instructions::Rdc(self.read_unumber(2), self.read_unumber(1)),
                70 => Instructions::Ptr(self.read_unumber(2)),
                71 => Instructions::Alc(self.read_unumber(1)),
                72 => Instructions::Goto(self.read_unumber(4)),
                73 => Instructions::Brnc(self.read_unumber(4), self.read_unumber(4)),
                74 => Instructions::Ret,
                75 => Instructions::Res(self.read_unumber(3), self.read_unumber(3)),
                76 => Instructions::Swap(self.read_unumber(1), self.read_unumber(1)),
                77 => Instructions::Add(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                78 => Instructions::Sub(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                79 => Instructions::Mul(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                80 => Instructions::Div(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                81 => Instructions::Mod(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                82 => Instructions::Equ(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                83 => Instructions::Grt(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                84 => Instructions::And(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                85 => Instructions::Or(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                86 => Instructions::Not(self.read_unumber(1), self.read_unumber(1)),
                87 => Instructions::Cal(self.read_unumber(3), self.read_unumber(2)),
                88 => Instructions::End,
                //89 => Instructions::Dalc,
                90 => Instructions::RAlc(self.read_unumber(1)),
                91 => Instructions::Idx(self.read_unumber(1)),
                //92 => Instructions::Repp,
                93 => Instructions::Less(self.read_unumber(1), self.read_unumber(1), self.read_unumber(1)),
                94 => Instructions::Debug(self.read_unumber(1)),
                95 => Instructions::Gotop,
                96 => Instructions::Ufrz,
                _ => {
                    panic!(
                        "Unexpected character '{}' at {}.",
                        self.file.as_bytes()[self.pos],
